...
local function constructNew_frmFabulas1_svg()
    ...
    obj.rectangle1:setHeight(118844);
...
function newfrmFabulas1_svg()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmFabulas1_svg();
      end,
      function()
...
local _frmFabulas1_svg = {
    newEditor = newfrmFabulas1_svg, 
    new = newfrmFabulas1_svg, 
    name = "frmFabulas1_svg", 
    dataType = "", 
    formType = "undefined", 
...
frmFabulas1_svg = _frmFabulas1_svg;
Firecast.registrarForm(_frmFabulas1_svg);

return _frmFabulas1_svg;
